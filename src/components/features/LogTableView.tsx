            ...
            <table className="w-full text-sm text-left border-collapse">
                <thead className="bg-muted/50 text-muted-foreground font-medium sticky top-0 z-10">
                    <tr>
                        ...
                        <th className="p-3 w-24 min-w-[90px]">{t('fields.date')}</th>
                        <th className="p-3 w-24 min-w-[90px]">{t('fields.category')}</th>
                        <th className="p-3 min-w-[150px]">{t('fields.title')}</th>
                        <th className="p-3 w-28 text-right header-amount">{t('fields.amount')}</th>
                                ...
                                >
                                    ...
                                    <td className="p-3 whitespace-nowrap text-muted-foreground font-medium">
                                        <div className="flex flex-col">
                                            <span>{format(parseISO(log.date), 'MM-dd')}</span>
                                            {log.start_time && (
                                                <span className="text-[10px] opacity-70">{log.start_time}</span>
                                            )}
                                        </div>
                                    </td>
